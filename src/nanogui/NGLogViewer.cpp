...
NGLogViewer::NGLogViewer(Widget *parent) : nanogui::Window(parent, "Log Viewer")
{
    this->setPosition(Vector2i(0, 600));
    ...
    textBox->setFixedSize(Vector2i(200, 100));
    textBox->setEditable(true);
    textBox->setValue("TESTING WHAT IS UP ???");
    textBox->setFontSize(14);
    textBox->setAlignment(TextBox::Alignment::Left);
}

NGLogViewer::~NGLogViewer()
{
}
